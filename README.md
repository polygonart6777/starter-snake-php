...
[![Run on Repl.it](https://repl.it/badge/github/Nettogrof/starter-snake-php)](https://repl.it/github/Nettogrof/starter-snake-php)

1. Login to your [Repl.it](https://repl.it) account.

2. Click the 'Run on Repl.it' button above, or visit the following URL: https://repl.it/github/Nettogrof/starter-snake-php.
